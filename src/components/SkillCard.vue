      ...
      <q-card class="q-ma-md techcard animation_zoomHover shadow-5">
        ...
        >
          <div class="cardsection q-pa-md">
            <q-card-section
              class="slide_left col-12"
              style="height: 100px; width: auto"
            >
              <div
                class="text-bold text-green fade-in animation_zoomHover col-12"
              >
                {{ name }}
              </div>
              <div class="overflow-hidden">
                <span
                  ...
                  :key="tool"
                  class="text-subtitle2 fade-in q-pr-xs"
                >
                  #{{ tool }}</span
                >
              </div>
        ...
        <q-card-section>
          <div class="">
            <q-badge
              ...
              rounded
              :color="
                status == 'Good' || status == 'Finished' ? 'green' : 'orange'
              "
              :label="status"
            />
          </div>
...
export default {
  ...
  props: {
    ...
    status: { type: String, default: "Good", required: true },
...
.cardsection :hover {
  background-color: rgb(15, 124, 77) !important;
  border-radius: 0rem 10rem 10rem 5rem !important;
}
