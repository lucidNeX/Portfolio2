  ...
  <div class="q-ma-none q-pa-none">
    ...
    >
      ...
      <template v-slot:content="scope">
        ...
        >
          <div class="text-h5 text-bold q-mt-lg text-center text-white">
            About me
          </div>
          <q-intersection
          ...
          >
            ...
            <div class="overlay2 q-pa-lg">
              ...
              <div
                class="text-subtitle1 text-white text-center fade-in3"
                :style="{}"
              >
                A Passionate Enthusiast Full-Stack-Developer graduated from NSS
                College of Engineering, Palakkad.<br />
                Interested in Dance and Music. <br />Iam a B-boy (Break boy in
                hiphop breaking) who seeks happiness in dancing. <br />Iam a
                Tabalist who loves to play with rythms. <br />In Simple, You can
                see me as a Passionate Techie and a B-boy from NSSCE Palakkad
                Rythmed by Resonance Dance Crew (RDC).
              </div>
              ...
              <div class="text-h5 text-bold q-my-md text-center">
                ...
                <q-btn
                  class="text-caption text-white fade-in5"
                  flat
                  @click="openContact"
                  >or Contact me?</q-btn
                >
                ...
                >
                  <span class="text-white text-subtitle2">
                    <a class="text-white" :href="phoneLink"
                      ><q-icon name="phone" class="q-pl-none q-mr-sm" />{{
                        info.phone
                      }}
                    </a></span
                  >
                  ...
                  <span class="text-white q-px-md text-subtitle2"
                    ><a class="text-white" :href="emailLink">
                      <q-icon name="mail" class="q-pl-none q-mr-sm" />{{
                        info.email
                      }}
                    </a></span
                  >
